...
// RegisterRoutes mounts workspace endpoints onto the router.
// All routes require auth middleware to be applied at the group level.
...
func (h *Handler) removeMember(c *fiber.Ctx) error {
	...
	// Users can remove themselves; only owners/admins can remove others
	// (full role enforcement comes in a later iteration)
	_ = claims

	if err := h.service.Leave(c.Context(), c.Params("id"), targetUserID); err != nil {
